...
class TabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let homeTabImage = UIImage.fontAwesomeIcon(name:.home, textColor: UIColor.black, size: CGSize.init(width: 35, height: 35))
        let addTabImage = UIImage.fontAwesomeIcon(name:.plusCircle, textColor: UIColor.black, size: CGSize.init(width: 35, height: 35))
        let settingTabImage = UIImage.fontAwesomeIcon(name:.cog, textColor: UIColor.black, size: CGSize.init(width: 35, height: 35))
